...
Most pipelines I've inherited drift toward incremental for reasons that, when written down, evaporate. <span class="text-neutral" style="font-style:italic;">"It's faster"</span> -- only at the cadence you're running it, and only until the cursor breaks. <span class="text-neutral" style="font-style:italic;">"It's cheaper"</span> -- depends on whether you're counting the cost of the drift you don't see. <span class="text-neutral" style="font-style:italic;">"The table is too big"</span> -- maybe true, maybe just never measured. The discipline isn't to ban incremental, it's to make sure every table that has it has earned it. Run that audit on a pipeline you inherited and you'll find half the tables can quietly move back to full replace, and the other half can finally be designed around their actual constraints rather than their inherited defaults.
